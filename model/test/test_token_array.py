...
class Test_TokenArray(TestCase):
    def test_initialization(self):
        ...
        self.assertIsInstance(ta.tokens, List)
        self.assertEqual(len(ta.tokens), 6)

    def test_withdraw_token(self):
        ta = TokenArray([2, 2, 2, 2, 2, 2])
        ta.withdraw_token(Color.WHITE, 1)
        self.assertEqual(ta.tokens, [1, 2, 2, 2, 2, 2])
    ...
    def test_withdraw_tokens(self):
        ...
        self.assertEqual(ta.tokens, [1, 1, 1, 1, 2, 2])
    ...
    def test_deposit_token(self):
        ...
        self.assertEqual(ta.tokens, [3, 2, 2, 2, 2, 2])

    def test_deposit_tokens(self):
        ta = TokenArray([2, 2, 2, 2, 2, 2])
        ta.deposit_tokens(TokenArray([1, 1, 1, 1, 0, 0]))
        self.assertEqual(ta.tokens, [3, 3, 3, 3, 2, 2])
    ...
    def test_add(self):
        ...
        self.assertEqual((ta1 + ta2).tokens, [4, 4, 4, 4, 4, 4])

    def test_sub(self):
        ta1 = TokenArray([3, 3, 3, 3, 3, 3])
        ta2 = TokenArray([2, 2, 2, 2, 2, 2])
        self.assertEqual((ta1 - ta2).tokens, [1, 1, 1, 1, 1, 1])
